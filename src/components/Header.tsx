...
const Header: FC = () => (
  <header className="pb-[76px] relative z-50">
    ...
    <Link href="/" className="absolute flex ">
      ...
      <h1 className="text-3xl pt-3 font-black text-fg/90 font-logo hover:text-fg transition whitespace-nowrap tracking-wide">
        Lila Rest
      </h1>
    </Link>
    <div className="fixed right-0 flex pr-4  gap-7">
