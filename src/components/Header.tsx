...
const Header: FC = () => (
  <header className="pb-[76px] relative z-50">
    ...
    <Link href="/" className="absolute flex hover:opacity-80 transition-opacity">
      ...
      <h1 className="text-3xl pt-3 font-black text-fg/95 font-logo transition whitespace-nowrap tracking-wide">
        Lila Rest
      </h1>
    </Link>
    <div className="fixed right-0 flex p-7 gap-7">
      <nav className="flex items-center">
        <ul className="flex gap-7 font-semibold">
          <li className="flex justify-center items-center hover:text-fg/70">
